...
<header class="header">
  <div class="header-top">
    <div class="logo">
      <h1 class="logo-title"><a class="logo-link" href="./index.php"><img class="logo-img" src="./public/icons/logo_true_title.png" alt="SynVRea"/></a></h1>
    </div>
    <nav class="nav">
      <ul class="nav-ul">
        <li class="nav-li"><a class="nav-link" href="#">お知らせ</a></li>
        <li class="nav-li"><a class="nav-link" href="#">活動概要</a></li>
        <li class="nav-li"><a class="nav-link" href="#">サービス</a></li>
        <li class="nav-li"><a class="nav-link" href="#">メンバー</a></li>
        <li class="nav-li"><a class="nav-link" href="#">お問い合わせ</a></li>
      </ul>
    </nav>
  </div>
